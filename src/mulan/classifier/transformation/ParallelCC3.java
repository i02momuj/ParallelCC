 ...
 * @version 2012.02.27
 */
public class ParallelCC3 extends TransformationBasedMultiLabelLearner {
     ...
     */
    public ParallelCC3(Classifier classifier, int[] aChain) {
        super(classifier);
        chain = aChain;
    }
     ...
     * used for training each of the binary models
     */
    public ParallelCC3(Classifier classifier) {
        super(classifier);
    }
