 ...
 * @version 2012.02.27
 */
public class ParallelCC2 extends TransformationBasedMultiLabelLearner {
     ...
     */
    public ParallelCC2(Classifier classifier, int[] aChain) {
        super(classifier);
        chain = aChain;
    }
     ...
     * used for training each of the binary models
     */
    public ParallelCC2(Classifier classifier) {
        super(classifier);
    }
...
//        System.out.println(toRemoveLabels.toString());
...
//            }
            ...
            System.out.println(train.getFeatureIndices().length);
...
//            Attribute pred = trainDataset.attribute(0);
//            pred.s
            
//            trainDataset.replaceAttributeAt(pred, 0); // = trainDataset.attribute(1); 
        }
    }
